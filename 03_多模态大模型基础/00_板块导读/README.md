...
如果说 [大语言模型基础](../../02_大语言模型基础/README.md) 主要回答“模型如何理解和生成语言”，那多模态这一部分要追问的是：
...
| 范围 | 本板块关注 | 延伸到其他板块 |
| --- | --- | --- |
| 图像理解 | 视觉编码器、图文对齐、VLM、OCR、VQA | 图像生成细节进入 [AI 图像生成](../../04_AI图像生成/README.md) |
| 视频理解 | 帧采样、时序建模、长视频理解、视频问答 | 视频生成细节进入 [AI 视频生成](../../05_AI视频生成/README.md) |
| 音频语音 | ASR、TTS、Audio-Language、实时语音交互 | 专项语音工程后续单独扩展 |
| LLM 底座 | 多模态系统中 LLM 的角色和约束 | LLM 原理进入 [大语言模型基础](../../02_大语言模型基础/README.md) |
| Agent 应用 | 多模态 RAG、GUI Agent、工具调用 | Agent 框架进入 [Agent](../../07_Agent/README.md) |
| 部署工程 | 视觉 Token、KV Cache、显存和延迟影响 | Serving、量化、并行进入 [大模型推理与部署](../../09_大模型推理与部署/README.md) |
...
记录论文时不必复述全文，围绕这五个问题保留方法、证据、局限和可迁移结论即可。
