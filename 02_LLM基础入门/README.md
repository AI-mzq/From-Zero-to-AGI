...
## 2. [Token 与 Embedding](02_Token与Embedding/README.md)
...
## 6. [主流 LLM 架构演进](06_主流LLM架构演进/README.md)
...
## 14. [论文综述](14_论文综述/README.md)

建议从综述论文和经典基础论文开始，再进入具体方向。

- LLM 总览综述
- Transformer / GPT / Scaling Law 经典论文
- LLaMA、Qwen、DeepSeek 等技术报告
- MoE 与高效架构论文
- 预训练、指令微调与对齐论文
- Prompt、推理、RAG、Agent、评测与系统论文
- 论文阅读方法与笔记模板
